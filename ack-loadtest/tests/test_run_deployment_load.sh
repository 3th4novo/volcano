...
assert_contains "${manifest}" "scheduling.volcano.sh/queue-name: ack-loadtest"
...
assert_contains "${best_effort_wrapper_manifest}" "scheduling.volcano.sh/queue-name: ack-best-effort"
...
assert_contains "${skewed_manifest}" "scheduling.volcano.sh/queue-name: ack-loadtest"

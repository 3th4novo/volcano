...
assert_contains "${manifest}" "REQUEST_MEMORY_MI=\"500\""
assert_contains "${manifest}" "REQUEST_CPU_MILLICORES=\"200\""
...
assert_contains "${fixed_manifest}" "REQUEST_MEMORY_MI=\"1024\""
assert_contains "${fixed_manifest}" "REQUEST_CPU_MILLICORES=\"300\""
